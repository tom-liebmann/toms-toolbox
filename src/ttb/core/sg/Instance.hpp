...
namespace ttb
{
    namespace sg
    {
        ...
        {
        public:
            Instance( std::list< const Modifier* > modifiers, const LeafNode* leafNode );
...
namespace ttb
{
    namespace sg
    {
        inline Instance::Instance( std::list< const Modifier* > modifiers,
                                   const LeafNode* leafNode )
            : m_modifiers( std::move( modifiers ) ), m_leafNode( leafNode )
        {
        }
