...
{
    template < class Type >
    inline Quaternion< Type >::Quaternion() : m_w( 1 ), m_x( 0 ), m_y( 0 ), m_z( 0 )
    {
    }
...
template < class Type >
ttb::Quaternion< Type > operator*( const ttb::Quaternion< Type >& quat1,
                                   const ttb::Quaternion< Type >& quat2 )
{
    return ttb::Quaternion< Type >( quat1.w() * quat2.w() - quat1.x() * quat2.x() -
...
template < class Type >
ttb::Quaternion< Type > operator*( const ttb::Quaternion< Type >& quat, Type scalar )
{
    return ttb::Quaternion< Type >( quat.w() * scalar, quat.x() * scalar, quat.y() * scalar,
                                    quat.z() * scalar );
}
...
template < class Type >
ttb::Vector< Type, 3 > operator*( const ttb::Quaternion< Type >& quat,
                                  const ttb::Vector< Type, 3 >& vec )
{
    ttb::Quaternion< Type > inv = quat.invert();
    ttb::Quaternion< Type > x( 0, vec.x(), vec.y(), vec.z() );
    inv = quat * x * inv;
    return ttb::Vector< Type, 3 >( { inv.x(), inv.y(), inv.z() } );
}


template < class Type >
std::ostream& operator<<( std::ostream& stream, const ttb::Quaternion< Type >& quat )
{
