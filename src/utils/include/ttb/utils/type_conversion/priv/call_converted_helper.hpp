...
namespace ttb
{
    namespace priv
    {
        ...
        struct call_converted_helper
        {
            ...
            static TResult
                call( TSignature const& function, TArgs1 const& args1, TArgs3&&... args3 );
        };
...
namespace ttb
{
    namespace priv
    {
        ...
        inline TResult call_converted_helper< TResult, TArgs1, TArgs2, TIndex >::call(
            TSignature const& function, TArgs1 const& args1, TArgs3&&... args3 )
        {
            ...
            if constexpr( std::is_same_v< void, TResult > )
            {
                call_converted_helper< TResult, TArgs1, TArgs2, TIndex - 1 >::call(
                    function,
                    args1,
                    convert_to< Type1, Type2 >::call( std::get< TIndex - 1 >( args1 ) ),
