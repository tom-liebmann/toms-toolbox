package com.juicy_trash.pong_royale;
...
import com.juicy_trash.ApplicationLib;
...
class MainView extends GLSurfaceView
{
    ...
    private void init( Context context, int depth, int stencil )
    {
    ...
    private static class ContextFactory implements GLSurfaceView.EGLContextFactory
    {
        ...
        {
            Log.w( TAG, "creating OpenGL ES 3.2 ext context" );
    ...
    private static class ConfigChooser implements GLSurfaceView.EGLConfigChooser
    {
        ...
        private static int[] s_configAttribs2 = { EGL10.EGL_RED_SIZE,
                4,
